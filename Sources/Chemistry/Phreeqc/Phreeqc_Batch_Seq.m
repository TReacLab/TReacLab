...
classdef Phreeqc_Batch_Seq < Solve_Engine
    properties
    ...
    methods
        function this = Phreeqc_Batch_Seq (cell)
        ...
        function b_t=Time_Stepping (this, parm)
            ...
            modify_string = this.Create_Modify_String ( ListSol, ListSolid, A_Sol, B_Solid,index_h2o, index_o, index_h, index_cb, dt, rows_chem);
            this.iphreeqc.RunString(modify_string);
            
            % OUTPUT OR DUMPFILE OFF
            if cancel_dump_file==true
                this.this.SetOFF_Output_File();
            end
        ...
        function String_mod=Create_Modify_String (this, ListSol, ListSolid, A_Sol_NoNeg, B_Solid, index_h2o, index_o, index_h, index_cb, dt, rows_chem)
            d=length(rows_chem);
            String_mod='';
            ...
            String_mod=sprintf([String_mod, s, s2]);
        end
