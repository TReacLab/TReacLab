...
classdef LinearTransportFD_1D_ConstantVelDiffMesh_modLunnbench < Solve_Engine
    properties 
        dx
        L
        velocity
    ...
    methods 
        ...
        %
        function this = LinearTransportFD_1D_ConstantVelDiffMesh_modLunnbench (Morphology, Equation, Initial_Field)
...
%             end
            ...
            for i = 1:c
                inv_E = inv(diag(Constant_Storage_Term(:,i)));
                C_n1 (:, i) = C_n(:, i) + dt*(inv_E*((this.M*C_n(:, i))+q(:,i)));
            end
