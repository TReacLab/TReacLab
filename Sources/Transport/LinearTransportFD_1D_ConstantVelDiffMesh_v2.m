...
classdef LinearTransportFD_1D_ConstantVelDiffMesh_v2 < Solve_Engine
    properties 
        dx
        L
        velocity
    ...
    methods 
        ...
        %
        function this = LinearTransportFD_1D_ConstantVelDiffMesh_v2 (Morphology, Equation, Initial_Field)
...
%             end
            ...
            C_n0 = C_n;
            coun_sub_dt=0;
            while coun_sub_dt<dt
                % C_n1 = C_n + inv(E)*(dT*(M*C_n+q))
                for i = 1:c
                    C_n1 (:, i) = C_n0(:, i) + inv_E*(sub_dt*((this.M*C_n0(:, i))+q(:,i)));
                end
                C_n0 = C_n1;
                coun_sub_dt = coun_sub_dt+sub_dt;
            end
